...
71. [Поняття гіпертексту. Засоби створення та перегляду гіпертекстових документів.
Особливості мови розмітки НТМL. Тегова модель. Класифікація тегів. Основні теги мови
НТМL для створення гіпертекстового документа. Приклади.](./71.md)
72. [База даних. Види](./72.md)
73. [Системи опрацьовування текстів, їх класифікація та функції. Основні формати текстових
файлів і їх перетворення.](./73.md)
74. [Математичне забезпечення обчислювальних систем.](./74.md)
75. [Організація пошуку інформації в глобальній мережі. Способи збереження веб-сторінок та їх
частин. Особливості збереження зображень і звуку. Приклади.](./75.md)
76. [Клієнт-серверна система. Призначення. Поняття клієнту та серверу](./76.md)
77. [Поняття алгоритму. Властивості алгоритмів. Базові структури алгоритмів та їх основні
властивості.](./77.md)
78. [Розподілені системи обробки інформації. Визначення. Призначення.](./78.md)
79. [Основні команди для роботи з таблицями в реляційних базах даних: створення структури
записів, заповнення даними, редагування даних. Приклади.](./79.md)
